...
call s:initVariable("g:NERDTreeMapPreview", "o")
...
call s:initVariable("g:NERDTreeMapActivateNode", "g" . NERDTreeMapPreview)
...
command! -n=? -complete=dir -bar Tree :call s:toggle('<args>')
